...
import com.auth.usermanagement.adapter.out.jpa.mapper.ModuleJPAMapper;
...
import com.auth.usermanagement.domain.port.out.ModuleRepositoryPort;
...
public class ModuleRepositoryAdapter implements ModuleRepositoryPort {
    ...
    public Page<ModuleDomain> searchByName(String name, Pageable pageable) {
        try {
            ...
            log.error("Error al buscar módulos por nombre='{}' (normalizado) : {} - causa: {}", name, e.getMessage(),
