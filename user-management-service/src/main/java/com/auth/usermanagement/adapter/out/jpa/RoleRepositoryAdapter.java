...
import com.auth.usermanagement.adapter.out.jpa.mapper.RoleJPAMapper;
...
public class RoleRepositoryAdapter implements RoleRepositoryPort {
    ...
    @Override
    public Optional<RoleDomain> findByName(RoleName name) {
        try {
    ...
    public Page<RoleDomain> searchByName(String name, Pageable pageable) {
        try {
            ...
            log.error("Error al buscar roles por nombre='{}' (normalizado) : {} - causa: {}", name, e.getMessage(),
