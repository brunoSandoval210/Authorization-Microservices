package com.auth.usermanagement.domain.model.permission;
...
import com.auth.usermanagement.domain.model.permission.vo.PermissionModule;
...
public class PermissionDomain {
    ...
    public PermissionDomain(PermissionId permissionId, PermissionName name, PermissionDescription description,
            PermissionModule module, Status status) {
