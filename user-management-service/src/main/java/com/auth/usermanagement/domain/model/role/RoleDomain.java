package com.auth.usermanagement.domain.model.role;

import com.auth.usermanagement.domain.model.permission.PermissionDomain;
import com.auth.usermanagement.domain.model.role.vo.*;
import com.common.shared.domain.model.Status;
import com.common.shared.domain.exception.NullValueException;
import com.common.shared.domain.exception.PermissionAlreadyAssignedException;
import com.common.shared.domain.exception.PermissionNotAssignedException;
...
public class RoleDomain {
    ...
    public RoleDomain(RoleId roleId, RoleName name, RoleDescription description, Set<PermissionDomain> permissions,
            Status status) {
        if (roleId == null) {
