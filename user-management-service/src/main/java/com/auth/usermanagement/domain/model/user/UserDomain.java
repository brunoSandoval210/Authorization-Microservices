package com.auth.usermanagement.domain.model.user;
...
import com.auth.usermanagement.domain.model.user.vo.UserNames;
...
import com.common.shared.domain.exception.RoleAlreadyAssignedException;
import com.common.shared.domain.exception.RoleNotAssignedException;
...
public class UserDomain {
    ...
    public UserDomain(UserId userId, UserNames names, UserEmail email, UserPassword password, AccountStatus status,
