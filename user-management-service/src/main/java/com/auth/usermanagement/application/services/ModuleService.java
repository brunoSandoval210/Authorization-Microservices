...
import com.auth.usermanagement.application.services.mapper.ModuleMapper;
 ...
 * - Aplicar reglas básicas: validación de existencia, mapeo entre request y
 * dominio, preservación de campos auditables.
