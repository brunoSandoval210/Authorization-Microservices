...
import com.common.shared.infrastructure.web.RequestIdFilter;
    ...
    public Optional<String> getCurrentAuditor() {
        ...
        try {
            ...
            if (authentication != null && authentication.isAuthenticated()) {
                ...
                log.debug("SecurityAuditorAware: principal class = {}",
                        principal == null ? "null" : principal.getClass().getName());

                if (principal instanceof UserSecurityResponse) {
                    UserSecurityResponse ap = (UserSecurityResponse) principal;
